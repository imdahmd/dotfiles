...
(def formulae ["git" "mit-scheme" "openjdk@17" "jenv" "clojure" "docker" "colima" "ispell" "pandoc" "iperf3" "terraform" "azure-cli" "jq" "docker-compose" "docker-credential-helper" "go" "awscli"])
